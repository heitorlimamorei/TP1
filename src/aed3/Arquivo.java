...
public class Arquivo<T extends Registro> {
    ...
    public Arquivo(String na, Constructor<T> c) throws Exception {
        ...
        File entityDir = new File(baseDir, na);
        if(!entityDir.exists())
            entityDir.mkdir();

        this.nomeArquivo = new File(entityDir, na+".db").getPath();
        this.construtor = c;
        ...
        indiceDireto = new HashExtensivel<>(
            ...
            4, 
            new File(entityDir, na+".d.db").getPath(), // diretório 
            new File(entityDir, na+".c.db").getPath()  // cestos
        );
    }
